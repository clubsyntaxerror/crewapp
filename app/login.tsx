...
export default function LoginScreen() {
  ...
  const handleDiscordLogin = async () => {
    try {
      ...
      Alert.alert(STRINGS.ERRORS.LOGIN_FAILED_TITLE, errorMessage, [
        { text: "OK" },
      ]);
    } finally {
      setLoading(false);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        {/* Info Text */}
        <Text style={styles.infoText}>{STRINGS.LOGIN.INFO_TEXT}</Text>
      </View>

      {/* Footer */}
      <View style={styles.footer}>
        <Text style={styles.footerText}>{STRINGS.LOGIN.FOOTER_TEXT}</Text>
      </View>
    </View>
  );
}
