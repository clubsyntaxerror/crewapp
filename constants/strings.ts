...
export const STRINGS = {
  // App branding
  APP_NAME: 'Club Syntax Error',
  APP_TITLE: 'Club Syntax Error Events',
  APP_SHORT: 'Crew App',
  ...
  LOGIN: {
    ...
    INFO_TEXT: 'This app is for crew & volunteers to manage event responsibilities.',
  ...
  EVENT: {
    ...
    UNAUTHORIZED_MESSAGE: 'Want to help out with our events? Reach out to us on Discord to learn about volunteering!',
  },
